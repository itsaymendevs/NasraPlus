...
class MessagesPickupProcessing extends Component
{
    ...
    public function mount()
    {
        ...
        // 1: dependencies
        $message = Message::where('isFor', 'Pickup')
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.help.group.messages.components.messages-pickup-processing');
