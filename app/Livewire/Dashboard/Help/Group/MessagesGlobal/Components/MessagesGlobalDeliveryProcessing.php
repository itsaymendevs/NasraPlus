...
class MessagesGlobalDeliveryProcessing extends Component
{
    ...
    public function mount()
    {
        ...
        // 1: getUser
        $message = MessageGlobal::where('isFor', 'Delivery')
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.help.group.messages-global.components.messages-global-delivery-processing');
