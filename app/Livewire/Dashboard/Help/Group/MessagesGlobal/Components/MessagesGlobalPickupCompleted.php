...
class MessagesGlobalPickupCompleted extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.help.group.messages-global.components.messages-global-pickup-completed');
