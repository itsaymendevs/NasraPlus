...
class OrderController extends Controller
{
    ...
    public function makeOrder(Request $request)
    {
        ...
        foreach ($previousOrderProducts as $previousOrderProduct) {
            ...
            $content->orderProductQuantity = strval(number_format($previousOrderProduct->orderProductQuantity, 2, '.', ''));            $content->orderProductPrice = strval($previousOrderProduct->orderProductPrice);
