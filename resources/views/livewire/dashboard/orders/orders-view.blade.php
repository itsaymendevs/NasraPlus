                        ...
                        <ul class="nav nav-pills nav-justified" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" role="tab" data-bs-toggle="pill"
                                    href="#processing-tab">Processing Order</a>
                            </li>
                            ...
                            <div class="tab-pane fade show active" role="tabpanel" id="processing-tab">
                                <div class="row mx-0">
                                                ...
                                                <div class="tab-pane fade show active" role="tabpanel" id="note-tab">
                                                    <div class="row px-4 py-4 bg-white rounded-1 shadow-sm">
                                                        ...
                                                        <div class="col-9">
                                                            ...
                                                            <textarea
                                                                class="form--input form--textarea w-100"></textarea>
                                                        </div>
                                    ...
                                    <div class="col-12 text-center mb-4" id="processing-buttons">
                                        ...
                                        {{-- 2: next --}}
                                        <button class="btn btn--theme btn--sm px-4 rounded-1 fs-13 text-capitalize"
                                            type="button">
                                            Next Process
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-12" id="processing-steps">
                                        <div class="processing-steps rounded-1">
                                            ...
                                            {{-- 1: pending --}}
                                            <button
                                                class="btn btn--sm px-4 rounded-1 fs-13 text-capitalize scale--3 active"
                                                type="button">
                                    ...
                                    <div class="col-1">
                                        <button class="btn fs-3 btn--raw-icon scale--3" type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                ...
                                                style="fill: var(--bg-theme-dark)" title="CyberPay">
                                                <path
