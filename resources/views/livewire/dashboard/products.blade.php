            ...
            <div class="row g-0 align-items-end">
                ...
                <div class="col-6 text-start">
                    ...
                    <label class="btn btn--export scale--3 px-4" role="button" wire:loading.class='disabled'
                        ...
                        <p class='text-start text-white mb-0 fs-10'>SN <br />Name <br />Name in Arabic <br />Company ID <br />Type ID <br />Buy Price <br />Sell Price <br />Offer Price <br />Weight / Size Option <br />Weight / Size <br />Unit ID <br />no. Of Units <br />Quantity / Unit <br />Total Quantity <br />Maximum Quantity / Order <br />Description <br />Description in Arabic <br />Hide Product <br />Show on Home</p>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
