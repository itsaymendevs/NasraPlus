                    ...
                    <div class="tab--wrap">
                        ...
                        <ul class="nav nav-pills nav-justified" role="tablist" wire:ignore>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" role="tab" data-bs-toggle="pill" href="#user-tab-7">User</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" role="tab" data-bs-toggle="pill" href="#receiver-tab-7">Receiver</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pb-0">
                            ...
                            {{-- 1: user --}}
                            <div class="tab-pane active" role="tabpanel" id="user-tab-7" wire:ignore.self>
                                <form wire:submit='update' wire:loading.class='disabled' class="row align-items-center">
                                    ...
                                    <div class="col-6 mb-4">
                                        ...
                                        <textarea class="form--input form--textarea"
                                            wire:model.live='instance.contentAr' placeholder="Arabic Text"></textarea>
                                    </div>
                            ...
                            {{-- 2: receiver --}}
                            <div class="tab-pane" role="tabpanel" id="receiver-tab-7" wire:ignore.self>
                                <form wire:submit='updateReceiver' wire:loading.class='disabled'
                                    ...
                                    <div class="col-6 mb-4">
                                        ...
                                        <textarea class="form--input form--textarea"
                                            wire:model.live='instanceReceiver.contentAr' required
