<div class="accordion-item results--order results--sms">
    ...
    {{-- content --}}
    <div class="accordion-collapse collapse item-2 pt-2" role="tabpanel" data-bs-parent="#results--sms-delivery"
        wire:ignore.self>
                    ...
                    <div class="tab--wrap">
                        ...
                        <ul class="nav nav-pills nav-justified" role="tablist" wire:ignore>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" role="tab" data-bs-toggle="pill" href="#user-tab-2">User</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" role="tab" data-bs-toggle="pill" href="#receiver-tab-2">Receiver</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pb-0">
                            ...
                            {{-- 1: user --}}
                            <div class="tab-pane active" role="tabpanel" id="user-tab-2" wire:ignore.self>
                            ...
                            {{-- 2: receiver --}}
                            <div class="tab-pane" role="tabpanel" id="receiver-tab-2" wire:ignore.self>
