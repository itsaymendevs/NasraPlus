...
<div>
      ...
      <div class="row">
         ...
         <div class="col-6 text-center align-self-end mb-4 pb-3">
            <div class="form-check form-switch form--switch xl">
               <input class="form-check-input" type="checkbox" id="rectangle-isActive-3"
                  wire:model='instance.isActive' />
               <label class="form-check-label ps-2" for="rectangle-isActive-3">Show Advertisement</label>
            </div>
         </div>
         ...
         <div class="col-6 align-self-end mt-4">
            <label class="img--holder for-square-ads upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
               for="square--file-1" title="Click To Upload">
               ...
               {{-- input --}}
               <input class="form-control d-none file--input" id="square--file-1" data-preview="square--preview-1"
                  type="file" accept="image/*" wire:model='instance.imageFile' required />


               {{-- preview --}}
               <img class="inventory--image-frame" id="square--preview-1" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
         ...
         <div class="col-6 align-self-end mt-4">
            <label class="img--holder for-square-ads upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
               for="square--file-2" title="Click To Upload">
               ...
               {{-- input --}}
               <input class="form-control d-none file--input" id="square--file-2" data-preview="square--preview-2"
                  accept="image/*" type="file" wire:model='instance.imageFileAr' required />


               {{-- preview --}}
               <img class="inventory--image-frame" id="square--preview-2" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
   ...
   <div id="results--row" class="mb-5 pb-4">
      ...
      <div class="row g-0 align-items-center results--item" key='square-ad-{{ $ad->id }}'>
         ...
         <div class="col-1">
            <div class="dropstart d-flex justify-content-center">
               ...
               <div class="dropdown-menu results--dropdown-menu">
                  ...
                  {{-- 1: edit --}}
                  <a class="dropdown-item" href='javascript:void(0);' data-bs-target="#advertisements-square-edit"
                     data-bs-toggle="modal" wire:click='edit({{ $ad->id }})'>Edit</a>



                  {{-- 2: remove --}}
                  <a class="dropdown-item" href="javascript:void(0);" wire:click='remove({{ $ad->id }})'>Remove</a>
               </div>
            </div>
         </div>
