            ...
            <div class="row align-items-center">
               ...
               <div class="col-6 align-self-end mt-4 mb-4">
                  <label class="img--holder for-square-ads upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                     for="square--file-3" title="Click To Upload">
                     ...
                     {{-- input --}}
                     <input class="form-control d-none file--input" id="square--file-3" data-preview="square--preview-3"
               ...
               <div class="col-6 align-self-end mt-4 mb-4">
                  <label class="img--holder for-square-ads upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                     for="square--file-4" title="Click To Upload">
                     ...
                     {{-- input --}}
                     <input class="form-control d-none file--input" id="square--file-4" data-preview="square--preview-4"
                        accept="image/*" type="file" wire:model='instance.imageFileAr' />
