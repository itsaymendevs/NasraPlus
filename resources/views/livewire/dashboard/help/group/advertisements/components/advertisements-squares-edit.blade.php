<div class="modal fade" role="dialog" tabindex="-1" id="advertisements-square-edit" wire:ignore.self>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6 text-center align-self-end mb-4 pb-3">
                        <div class="form-check form-switch form--switch xl">
                            <input class="form-check-input" type="checkbox" id="square-isActive-2"
                                wire:model='instance.isActive' />
                            <label class="form-check-label ps-2" for="square-isActive-2">Show Advertisement</label>
                        </div>
                    </div>
                    ...
                    <div class="col-6 align-self-end mt-4 mb-4">
                        <label class="img--holder for-square-ads upload--wrap" data-bs-toggle="tooltip"
                            data-bss-tooltip="" for="square--file-3" title="Click To Upload">
                            ...
                            {{-- input --}}
                            <input class="form-control d-none file--input" id="square--file-3"
                                data-preview="square--preview-3" type="file" accept="image/*"
                                wire:model='instance.imageFile' />


                            {{-- preview --}}
                            <img class="inventory--image-frame" id="square--preview-3"
                    ...
                    <div class="col-6 align-self-end mt-4 mb-4">
                        <label class="img--holder for-square-ads upload--wrap" data-bs-toggle="tooltip"
                            data-bss-tooltip="" for="square--file-4" title="Click To Upload">
                            ...
                            {{-- input --}}
                            <input class="form-control d-none file--input" id="square--file-4"
                                data-preview="square--preview-4" accept="image/*" type="file"
                                wire:model='instance.imageFileAr' />


                            {{-- preview --}}
                            <img class="inventory--image-frame" id="square--preview-4"
                                src="{{ asset('assets/img/placeholder.png') }}" wire:ignore />
