      ...
      <div class="row">
         ...
         <div class="col-6 align-self-end mt-4">
            <label class="img--holder for-rectangle-ads upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               {{-- input --}}
               <input class="form-control d-none file--input" id="rectangle--file-1" data-preview="rectangle--preview-1"
         ...
         <div class="col-6 align-self-end mt-4">
            <label class="img--holder for-rectangle-ads upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               {{-- input --}}
               <input class="form-control d-none file--input" id="rectangle--file-2" data-preview="rectangle--preview-2"
         ...
         <div class="col-1">
            <div class="dropstart d-flex justify-content-center">
               ...
               <div class="dropdown-menu results--dropdown-menu">
                  ...
                  {{-- 1: edit --}}
                  <a class="dropdown-item" href='javascript:void(0);' data-bs-target="#advertisements-rectangle-edit"
