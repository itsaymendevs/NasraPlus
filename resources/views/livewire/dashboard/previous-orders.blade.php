   ...
   <section data-aos="fade-left" data-aos-duration="700" id="content--main" class="d-block mt-5 content--main mx-4">
      ...
      <div id="filters--wrap" class="mb-5">
         ...
         <div class="row align-items-end">
            ...
            <div class="col-4">
               <label class="col-form-label form--label profile--label scale--3"><svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="accordion-item results--order">
                     ...
                     <h2 class="accordion-header" role="tab">
                        <button class="accordion-button collapsed results--order-button" type="button"
                           data-bs-toggle="collapse" data-bs-target="#results--orders .item-1" aria-expanded="false"
                           ...
                           {{-- 3: state - deliveryRegion / pickupStore --}}
