                        ...
                        <div class="row g-0 align-items-center results--item" key='single-order-{{ $order->id }}'>
                            ...
                            <div class="col-1">
                                <label class="col-form-label form--label row--label">{{
                                    number_format(($order?->orderTotalPrice ?? 0) / $toSDG, 2) }}</label>
                            </div>
                ...
                <div class="tab-pane fade" role="tabpanel" id="favs-tab" wire:ignore.self>
                    ...
                    <div id="results--row-1">
                        ...
                        <div class="row g-0 align-items-center results--item" key='single-favorite-{{ $favorite->id }}'>
                            ...
                            {{-- 2: name --}}
                            <div class="col-3">
                                <label class="col-form-label form--label row--label me-2">{{ $favorite->product?->name
                                    }}</label>
                            </div>
                            ...
                            <div class="col-3">
                                <label class="col-form-label form--label row--label">{{
                                    number_format(($favorite->product?->sellPrice ?? 0) / $toSDG, 2) }} / {{
                                    $favorite?->product?->offerPrice ?
                                    number_format($favorite->product->offerPrice / $toSDG, 2) : '-' }}</label>
                            </div>
