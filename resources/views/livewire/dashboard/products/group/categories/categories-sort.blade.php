...
<div class="col-9 content--col px-0" id="content--col">
    ...
    {{-- section --}}
    <form wire:submit='update' wire:loading.class='disabled' data-aos="fade-left" data-aos-duration="700"
        id="content--main" class="d-block mt-5 content--main mx-4" wire:ignore.self>
        ...
        <div id="results--row" wire:ignore>
            ...
            <div class="row g-0 align-items-center results--item sort--item" key='single-category-{{ $category->id }}'>
                ...
                {{-- hiddenSort --}}
                <input type="text" wire:model='list.{{ $category->id }}'>
