         ...
         <div class="row align-items-center">
            ...
            <div class="col-4">
               <a class="btn btn--theme btn--sort scalemix--3 px-4" role="button" data-bs-toggle="tooltip"
                  ...
                  href="main-categories-sort.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                     fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-down-up">
      ...
      <form wire:submit='updateCover' wire:loading.class='disabled' class="row">
         ...
         <div class="col-6 mb-4">
            <label class="img--holder for-category upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               {{-- preview --}}
               <img class="inventory--image-frame" id="cover--preview-1" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
         ...
         <div class="col-6 mb-4">
            <label class="img--holder for-category upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               {{-- preview --}}
               <img class="inventory--image-frame" id="cover--preview-2" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
