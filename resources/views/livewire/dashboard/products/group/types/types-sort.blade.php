...
<div class="col-9 content--col px-0" id="content--col">
    ...
    <section data-aos="fade-down" data-aos-duration="700" data-aos-delay="400" id="header--div"
        ...
        <livewire:dashboard.components.top-bar key='topBar' type='regular' leftTitle='Return'
            leftLink="{{ route('dashboard.types') }}" title='Sort Types' />
    ...
    <section data-aos="fade-left" data-aos-duration="700" id="content--main" class="d-block mt-5 content--main mx-4"
        ...
        <div id="results--row" wire:ignore>
            ...
            <div class="row g-0 align-items-center results--item sort--item" key='single-type-{{ $type->id }}'>




                {{-- type --}}
                <input type="hidden" class='sort--list' value='{{ $type->id }}'>
                ...
                {{-- serial --}}
                <div class="col-2">
                    <label class="col-form-label form--label row--label">CT-{{ $globalSNCounter++ }}</label>
                </div>
                ...
                {{-- nameAr --}}
                <div class="col-5">
                    <label class="col-form-label form--label row--label">{{ $type->nameAr }}</label>
                </div>
