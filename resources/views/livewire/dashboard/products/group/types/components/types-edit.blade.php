<div class="modal fade" role="dialog" tabindex="-1" id="types-edit" wire:ignore.self>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <div class="select--single-wrapper" wire:ignore>
                            <select id='subCategory-select-2' class="form--select form--modal-select"
                                data-instance='instance.subCategoryId' data-modal='#types-edit' required>
                                <option value=""></option>
    ...
    {{-- selectHandle --}}
    <script>
        $("#types-edit .form--modal-select").on("change", function(event) {
