{{-- sideBar --}}
<div class="col-3 align-self-stretch navbar--col bg-cover px-0 position-relative" id="navbar--col" wire:ignore>
    ...
    <div class="navbar--content">
        ...
        <img class="w-100 of-contain nav--logo mb-4" style="height: 160px"
            src="{{ url('assets/img/Logo/logo-login.png') }}" />
        ...
        <div class="nav--menu">
            <div class="btn-group-vertical w-100" role="group">
                ...
                <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                    ...
                    <a class="stretched-link regulate--link" href="{{ route('dashboard.orders') }}">Orders</a>
                </button>
                ...
                <div class="btn-group dropend navbar--split-btn">
                    ...
                    <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                        ...
                        <a class="stretched-link regulate--link" href="{{ route('dashboard.regions') }}">Delivery</a>
                    </button>
                    ...
                    {{-- subLinks --}}
                    {{-- 2.1: times - conditions --}}
                    <div class="dropdown-menu dropdown-menu-dark results--dropdown-menu">
                        <a class="dropdown-item" href="{{ route('dashboard.regions.times') }}">Times</a>
                        <a class="dropdown-item" href="{{ route('dashboard.regions.conditions') }}">Conditions</a>
