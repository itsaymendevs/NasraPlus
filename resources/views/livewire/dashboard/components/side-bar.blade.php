            ...
            <div class="btn-group-vertical w-100" role="group">
                ...
                <div class="btn-group dropend navbar--split-btn">
                    ...
                    <button class="btn fs-5 btn--navbar ps-3 scale--3 position-relative" type="button">
                        ...
                        <a class="stretched-link regulate--link" href="#">Products</a>
                    </button>
                    ...
                    {{-- subLinks --}}
                    {{-- 1.2: category - subCategory - type - companiess - units --}}
                    <div class="dropdown-menu dropdown-menu-dark results--dropdown-menu alternative">
                        <a class="dropdown-item" href="products/main-categories.html">Main Category</a>
                        <a class="dropdown-item" href="products/sub-categories.html">Sub Category</a>
                        <a class="dropdown-item" href="products/types.html">Inner Types</a>
                        <a class="dropdown-item" href="products/companies.html">Companies</a>
                        <a class="dropdown-item" href="products/units.html">Measuring Units</a>
                    </div>
                ...
                <div class="btn-group dropend navbar--split-btn">
                    ...
                    <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                        ...
                        <a class="stretched-link regulate--link" href="#">Delivery</a>
                    </button>
                    ...
                    <div class="dropdown-menu dropdown-menu-dark results--dropdown-menu">
                        <a class="dropdown-item" href="#">Conditions</a>
                    </div>
                ...
                <div class="btn-group dropend navbar--split-btn">
                    ...
                    <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                        ...
                        <a class="stretched-link regulate--link" href="../collects/index.html">Collection</a>
                    </button>
                ...
                <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                    ...
                    <a class="stretched-link regulate--link" href="#">Payment</a>
                </button>
                ...
                <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                    ...
                    <a class="stretched-link regulate--link" href="#">Customers</a>
                </button>
                ...
                <div class="btn-group dropend navbar--split-btn">
                    ...
                    <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                        ...
                        <a class="stretched-link regulate--link" href="../general/help.html">General Info</a>
                    </button>
                    ...
                    {{-- subLinks --}}
                    {{-- 6.1: help - contact - messages - advertisement --}}
                    <div class="dropdown-menu dropdown-menu-dark results--dropdown-menu">
                        <a class="dropdown-item" href="general/help.html">Help Page</a>
                        <a class="dropdown-item" href="general/contact-sd.html">Contact - SD</a>
                        <a class="dropdown-item" href="general/contact-uk.html">Contact - UK</a>
                        <a class="dropdown-item" href="general/contact-irl.html">Contact - IRL</a>
                        <a class="dropdown-item" href="general/sms.html">Messages - SD</a>
                        <a class="dropdown-item" href="general/sms-global.html">Messages - UK</a>
                ...
                <button class="btn fs-5 btn--navbar ps-3 scale--3" type="button">
                    ...
                    <a class="stretched-link regulate--link" href="#">Employees</a>
                </button>
