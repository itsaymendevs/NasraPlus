...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="https://fonts.googleapis.com/css?family=El+Messiri:400,500,600,700&amp;display=swap">
    ...
    <body>
        ...
        <section id="section--body" class='d-none d-lg-block'>
            <div class="container-fluid bg-cover bg--main px-0">
                <div class="row g-0 min-vh-100">
                    ...
                    {{-- 1: sideBar --}}
                    <livewire:dashboard.components.side-bar key='main--nav-sidebar' />
        ...
        <script src="{{url('assets/js/reinit-general.js')}}"></script>
        <script src="{{url('assets/js/reinit-select.js')}}"></script>
